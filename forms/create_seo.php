         ...
         <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation" aria-label="Main navigation" data-accordion="false" id="navigation">
                        ...
                        <li class="nav-item">
                            <a href="create_enquiry.php" class="nav-link">
                                <i class="nav-icon bi bi-download"></i>
                                <p>registration</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="create_marketing.php" class="nav-link">
                                <i class="nav-icon bi bi-grip-horizontal"></i>
                                <p>marketing</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="create_campaigns.php" class="nav-link">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">campaigns from</h3></div>
              <div class="col-sm-6">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                     <form action="insert_seo.php" method="POST">
    <div class="mb-3">
