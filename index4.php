...
if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true) {
    ...
    <div style="margin-top: 100px; text-align: center;">
        <p style="font-size: 22px; font-weight: bold;">
            <span style="color: red;">Unauthorized access. Please</span>
            <a href="index.php" style="color: blue; text-decoration: none;"> <b>login</b></a>.
        </p>
    </div>';
    exit();
}
?>
  ...
  <a href="forms/view_enquiry.php" class="nav-link active">
    ...
    <p>
      ...
      <i class=""></i>
              ...
              <li class="nav-item menu-open">
  <a href="forms/view_selection.php" class="nav-link active">
    <i class="nav-icon bi bi-speedometer"></i>
    <p>
      marketing
      <i class=""></i>
             ...
             <li class="nav-item menu-open">
  <a href="forms/view_report.php" class="nav-link active">
    <i class="nav-icon bi bi-speedometer"></i>
    <p>
      report
      <i class=""></i>
...
<li class="nav-item menu-open">
  <a href="forms/view_seo.php" class="nav-link active">
    <i class="nav-icon bi bi-speedometer"></i>
    <p>
      SEO
      <i class=""></i>
              ...
              <li class="nav-item">
              <a href="forms/create_marketing.php" class="nav-link">
